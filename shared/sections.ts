...
export const SECTION_DEFS: SectionMeta[] = [
  ...
  },
  {
    ...
    defaultContent: {
      ...
      jobs: [
        { title: "Customer Success Manager (CSM)", location: "Coimbatore / Hybrid", type: "Full-time", summary: "Own customer onboarding, adoption, renewals, and success outcomes for ERP implementation accounts.", responsibilities: [], requirements: [], applyText: "Apply Now", applyHref: "mailto:hr@konnectbi.com" },
        { title: "Marketing Associate", location: "Coimbatore", type: "Full-time", summary: "Support campaigns, content, events, lead generation, and partner marketing for KonnectERP.", responsibilities: [], requirements: [], applyText: "Apply Now", applyHref: "mailto:hr@konnectbi.com" },
        { title: "Customer Support Associate", location: "Coimbatore", type: "Full-time", summary: "Handle customer queries, coordinate issue resolution, and help users get more from the platform.", responsibilities: [], requirements: [], applyText: "Apply Now", applyHref: "mailto:hr@konnectbi.com" },
        {
          ...
          applyText: "Apply Now",
          applyHref: "mailto:hr@konnectbi.com",
        },
        { title: "ERP Technical Support", location: "Coimbatore", type: "Full-time", summary: "Support ERP configurations, technical tickets, integrations, and issue diagnosis for live customers.", responsibilities: [], requirements: [], applyText: "Apply Now", applyHref: "mailto:hr@konnectbi.com" },
        { title: "BDE/Sales Executive", location: "Chennai / Bengaluru", type: "Full-time", summary: "Build pipeline, qualify ERP opportunities, conduct demos, and coordinate with presales teams.", responsibilities: [], requirements: [], applyText: "Apply Now", applyHref: "mailto:hr@konnectbi.com" },
        { title: "COE (SME)", location: "Remote / Hybrid", type: "Full-time", summary: "Bring domain expertise to ERP templates, customer workshops, and best-practice process design.", responsibilities: [], requirements: [], applyText: "Apply Now", applyHref: "mailto:hr@konnectbi.com" },
      ],
    },
  },
  {
