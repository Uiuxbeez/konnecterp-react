...
export const SECTION_DEFS: SectionMeta[] = [
    ...
    fields: [
      ...
      { key: "description", label: "Description", type: "textarea" },
      {
        ...
        fields: [
          ...
          { key: "industry", label: "Industry / Short Label", type: "text" },
          { key: "website", label: "Website Link", type: "text" },
        ],
      },
    ],
    defaultContent: {
      ...
      description: "A dynamic client logo grid you can update anytime from the Page Builder. Add, remove, or reorder client cards as your customer list grows.",
      clients: [
        { logo: "/images/brands/brand-1.avif", name: "Client Logo 1", industry: "Manufacturing", website: "" },
        { logo: "/images/brands/brand-2.jpg", name: "Client Logo 2", industry: "Trading", website: "" },
        { logo: "/images/brands/brand-3.png", name: "Client Logo 3", industry: "Distribution", website: "" },
        { logo: "/images/brands/brand-4.jpg", name: "Client Logo 4", industry: "Operations", website: "" },
        { logo: "/images/brands/brand-5.png", name: "Client Logo 5", industry: "ERP", website: "" },
        { logo: "/images/brands/brand-6.jpg", name: "Client Logo 6", industry: "Business", website: "" },
        { logo: "/images/brands/brand-7.png", name: "Client Logo 7", industry: "Enterprise", website: "" },
      ],
    },
  },
  {
  ...
  // ── Resources template sections (used by /resources/:slug pages) ─────────
  {
    ...
    defaultContent: {
      ...
      description: "Konnect One provides implementation visibility throughout the ERP journey. Every milestone, requirement, task, and update stays visible and coordinated.",
    ...
    fields: [
      ...
      { key: "footerDescription", label: "Side Card Footer Description", type: "textarea" },
      {
        ...
        fields: [
          ...
          { key: "applyAction", label: "Apply Button Action", type: "select", options: BUTTON_ACTION_OPTIONS },
          { key: "applyHref", label: "Apply Button Link URL / Page Path", type: "text" },
        ],
      },
    ],
    defaultContent: {
      ...
      jobs: [
        { title: "Customer Success Manager (CSM)", location: "Coimbatore / Hybrid", type: "Full-time", summary: "Own customer onboarding, adoption, renewals, and success outcomes for ERP implementation accounts.", responsibilities: [], requirements: [], applyText: "Apply Now", applyAction: "custom_form_modal", applyHref: "" },
        { title: "Marketing Associate", location: "Coimbatore", type: "Full-time", summary: "Support campaigns, content, events, lead generation, and partner marketing for KonnectERP.", responsibilities: [], requirements: [], applyText: "Apply Now", applyAction: "custom_form_modal", applyHref: "" },
        { title: "Customer Support Associate", location: "Coimbatore", type: "Full-time", summary: "Handle customer queries, coordinate issue resolution, and help users get more from the platform.", responsibilities: [], requirements: [], applyText: "Apply Now", applyAction: "custom_form_modal", applyHref: "" },
        {
          ...
          applyText: "Apply Now",
          applyAction: "custom_form_modal",
          applyHref: "",
        },
        { title: "ERP Technical Support", location: "Coimbatore", type: "Full-time", summary: "Support ERP configurations, technical tickets, integrations, and issue diagnosis for live customers.", responsibilities: [], requirements: [], applyText: "Apply Now", applyAction: "custom_form_modal", applyHref: "" },
        { title: "BDE/Sales Executive", location: "Chennai / Bengaluru", type: "Full-time", summary: "Build pipeline, qualify ERP opportunities, conduct demos, and coordinate with presales teams.", responsibilities: [], requirements: [], applyText: "Apply Now", applyAction: "custom_form_modal", applyHref: "" },
        { title: "COE (SME)", location: "Remote / Hybrid", type: "Full-time", summary: "Bring domain expertise to ERP templates, customer workshops, and best-practice process design.", responsibilities: [], requirements: [], applyText: "Apply Now", applyAction: "custom_form_modal", applyHref: "" },
      ],
    },
  },
  {
